...
function show_character_picker () {
    ...
    character_selector_box = sprites.create(assets.image`test`, SpriteKind.Background)
...
music.play(music.createSong(assets.song`intro sang`), music.PlaybackMode.UntilDone)
