...
`;
    ...
    helpers._registerFactory("song", function(name: string) {
        switch(helpers.stringTrim(name)) {
            ...
            case "song2":
            case "mySong":return hex`0078000408020105001c000f0a006400f4010a0000040000000000000000000000000000000002180000000100012c08000900012c100011000122180019000119`;
        }
        return null;
    })
